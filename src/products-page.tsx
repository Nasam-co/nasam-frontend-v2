...
const ProductsPage = () => {
  ...
  const [importScenario, setImportScenario] =
    useState<ImportScenario>("new-seller");
  ...
  const [sortField, setSortField] = useState<
    "masterStock" | "totalUnitsSold" | "totalRevenue" | null
  >(null);
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("desc");

  // Modal state
  const [activeModal, setActiveModal] = useState<ModalType>(null);
  const [selectedSellerForImport, setSelectedSellerForImport] =
    useState<Seller>(sellers[0]);
  const [showImportSellerDropdown, setShowImportSellerDropdown] =
    useState(false);
  ...
  const getProductsForState = (state: DemoState) => {
    ...
    const createMarketplaceListings = (
      basePrice: number,
      ...
      const listings = [
        {
          ...
          marketplace: "Amazon",
          marketplaceIcon:
            "https://tinuiti.com/wp-content/uploads/2020/07/amazon-1-1.png",
          listPrice: basePrice,
          salePrice:
            Math.random() > 0.5 ? Math.floor(basePrice * 0.85) : undefined,
        ...
        },
        {
          ...
          marketplaceIcon:
            "https://d22nihcmq83fqg.cloudfront.net/sites/default/files/styles/icon_image/public/store_icon/trendyol-logo-en-arabiccoupon-trendyol-coupons-and-promo-codes-400x400.jpg",
          listPrice: basePrice,
          salePrice: undefined,
    ...
    const baseProducts = [
      {
        ...
        masterStock: 145,
        imageUrl:
          "https://getsunmed.com/cdn/shop/products/BeyondGummies-1-1-1-FS-750mg-30count.jpg?v=1680209565",
        totalUnitsSold: 127,
        totalRevenue: 37973,
  ...
  const getProductStatus = (product: Product) => {
    ...
    const failedCount = listedListings.filter(
      (l) => l.syncStatus === "failed"
    ).length;
    const pendingCount = listedListings.filter(
  ...
  const handleSort = (
    field: "masterStock" | "totalUnitsSold" | "totalRevenue"
  ) => {
    const newDirection =
...
HOME-001,29,29,480`;
    ...
    a.download =
      type === "full"
        ? "nasam-products-template.csv"
        : "nasam-bulk-update-template.csv";
                      ...
                      <div className="overflow-x-auto">
                        ...
                        >
                          <thead>
                            ...
                            >
                              <th
                                className="text-left p-4 font-medium resize-x"
                                style={{
                                      ...
                                      {hasAnyListings(product) ? (
                                        product.listings.filter(
                                          ...
                                          >
                                            ...
                                            >
                                              Marketplaces available but not
                                              listed
                                            </span>
                                          </div>
                                        )
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            style={{
                              backgroundColor:
                                importScenario === "existing-seller"
                                  ? "var(--accent)"
                                  : "var(--card)",
                              color:
                                importScenario === "existing-seller"
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "var(--muted-foreground)" }}
                      >
                        Import products for any seller. For new sellers, we'll
                        guide you to set up marketplace connections. For
                        existing sellers, products will automatically link to
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      onClick={() =>
                        setShowImportSellerDropdown(!showImportSellerDropdown)
                      }
                    ...
                    {showImportSellerDropdown && (
                      <div
                        className="absolute top-full left-0 right-0 mt-1 rounded-lg shadow-xl z-30"
                        style={{
                          backgroundColor: "var(--card)",
                          border: "1px solid var(--border)",
                        }}
                ...
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    style={{ color: "var(--muted-foreground)" }}
                  >
                    <strong>Complete product data:</strong> SKU, name,
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "var(--muted-foreground)" }}
                      >
                        Update prices and inventory across all sellers at once.
                        Perfect for discount campaigns or stock adjustments. We
                        automatically routes each SKU to the correct seller.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <label className="relative flex-1">
                      ...
                      >
                        ...
                        <span>
                          {isImporting ? "Processing..." : "Upload Updates"}
                        </span>
                      </div>
                    </label>
                  </div>
                  ...
                  <div
                    ...
                    style={{ color: "var(--muted-foreground)" }}
                  >
                    <strong>Update format:</strong> SKU + price and/or
                    inventory. Changes sync to all connected marketplaces.
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <span
                        ...
                        style={{ color: "var(--foreground)" }}
                      >
                        Processing Updates ({importProgress.processed}/
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            ...
            >
              <h3
                ...
                style={{ color: "var(--foreground)" }}
              >
                {importResults.type === "quick-updates"
                  ? "Quick Updates Complete!"
                  : "Import Complete!"}
              </h3>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    >
                      {importResults.type === "quick-updates"
                        ? importResults.summary.affectedSellers
                        : "1"}
                    </div>
                    <div
                      className="text-sm"
